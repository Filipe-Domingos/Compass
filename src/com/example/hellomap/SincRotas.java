...
import com.example.hellomap.db.entidade.ListaRota;
...
public class SincRotas extends AsyncTask<String, Integer, String>{
	Context context;
	ProgressDialog progresso;

	public SincRotas(Context context, ProgressDialog progresso) {
	...
	protected void onPostExecute(String result) {
		...
		ListaRota lista = g.fromJson(result, ListaRota.class);
